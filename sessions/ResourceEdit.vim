...
set grepprg=grep\ -nH\ $*
set guifont=ÇlÇr_ÉSÉVÉbÉN:h11:cSHIFTJIS
...
silent only
cd d:\WebSAMFW\Win\target\src\lib\NvPROResourceManager\NvPROResourceManagerSvc
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 NvPROResourceManagerSvc.rc
badd +0 resource.h
args NvPROResourceManagerSvc.rc
edit NvPROResourceManagerSvc.rc
...
let s:l = 2269 - ((21 * winheight(0) + 21) / 43)
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 550 - ((38 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
550
