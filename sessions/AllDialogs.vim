...
silent only
cd d:\work_spaces\WFRM\AllDialogs\Dialogs
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +1 WFRMPageLSPassword.h
badd +66 WFRMPageLSPassword.cpp
badd +59 E:/Tools/Vim/.vimrc
args WFRMPageLSPassword.h
edit WFRMPageLSPassword.cpp
...
exe 'vert 1resize ' . ((&columns * 88 + 69) / 138)
exe 'vert 2resize ' . ((&columns * 49 + 69) / 138)
argglobal
setlocal noarabic
setlocal autoindent
setlocal autoread
...
let s:l = 66 - ((36 * winheight(0) + 23) / 47)
