...
set tabstop=4
set tags=./tags,tags,E:/Tools/Vim/SDK_tags,E:/Tools/Vim/altmfc_tags
set title
set wildmenu
...
silent only
cd d:\work_spaces\FW\TwoRichEdit
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +42 WFRMLineEditor.cpp
badd +1 
badd +0 WFRMLineEditor.h
badd +1 InnerEditor.h
badd +12 InnerEditor.cpp
badd +1 InnerColumn.h
badd +0 InnerColumn.cpp
args WFRMLineEditor.cpp
edit WFRMLineEditor.h
...
exe 'vert 1resize ' . ((&columns * 49 + 61) / 123)
exe 'vert 2resize ' . ((&columns * 73 + 61) / 123)
argglobal
setlocal noarabic
setlocal autoindent
setlocal autoread
...
setlocal wrap
setlocal wrapmargin=0
let s:l = 43 - ((19 * winheight(0) + 21) / 43)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
43
...
wincmd t
set winheight=1 winwidth=1
exe 'vert 1resize ' . ((&columns * 73 + 61) / 123)
exe 'vert 2resize ' . ((&columns * 49 + 61) / 123)
argglobal
setlocal noarabic
setlocal autoindent
setlocal autoread
