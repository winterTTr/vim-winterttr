...
silent only
cd D:\WebSAMFW\Win\Make\DebugMgrUNICODE\log
if expand('%') == '' && !&modified && line('$') <= 1 && getline(1) == ''
  let s:wipebuf = bufnr('%')
endif
set shortmess=aoO
badd +6109 /WebSAMFW/Win/Make/DebugSvcUNICODE/log/WFRMSvc.trc
badd +1 WFRMMgr.trc
badd +0 NvPROResourceManagerMgr.trc
args NvPROResourceManagerMgr.trc
edit /WebSAMFW/Win/Make/DebugSvcUNICODE/log/WFRMSvc.trc
...
let s:l = 7305 - ((20 * winheight(0) + 21) / 43)
...
normal! 055l
tabnew
edit NvPROResourceManagerMgr.trc
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
